...
watch(
    ...
    () => {
        if (props.show) {
            ...
            form.building = props.item.building;
            form.building_level = props.item.building_level;
            form.room = props.item.room;
            form.shelf = props.item.shelf;
            form.space = props.item.space;
...
const editData = () => {
    form.patch(route("storage-locations.update", props.item.id), {
        preserveScroll: true,
