...
watch(
    ...
    () => {
        if (props.show) {
            form.block = props.item.block;
            form.level = props.item.level;
            form.number = props.item.number;
        }
    }
);

const editData = () => {
    form.patch(route("units.update", props.item.id), {
        preserveScroll: true,
            ...
            <div class="p-6">
                ...
                <div class="mt-6 flex justify-end">
                    ...
                    <PrimaryButton
                        class="ml-3"
                        :class="{
                            'opacity-25': form.processing || !form.block,
                        }"
